    ...
    function getListViewHtml(options) {
        ...
        for (var i = 0, length = items.length; i < length; i++) {
            ...
            if (options.image !== false) {
                ...
                if (playOnImageClick)
                {
                    // bb: Changed title to "Zur Episode" & data-action to "link" & no play icon
                    ...
                    html += '<button is="paper-icon-button-light" class="listItemImageButton itemAction" data-action="link"><span class="material-icons listItemImageButton-icon"></span>&rarr; Zur Episode</button>';
                }
